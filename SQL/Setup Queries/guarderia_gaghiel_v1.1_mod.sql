DROP DATABASE IF EXISTS `guarderia_gaghiel_mod`;

CREATE DATABASE  IF NOT EXISTS `guarderia_gaghiel_mod` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `guarderia_gaghiel_mod`;
-- MySQL dump 10.13  Distrib 8.0.39-30, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: guarderia_gaghiel_mod
-- ------------------------------------------------------
