CREATE DATABASE  IF NOT EXISTS `convenciones_underground_mod` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `convenciones_underground_mod`;
-- MySQL dump 10.13  Distrib 8.0.32, for Linux (x86_64)
--
-- Host: 127.0.0.1    Database: convenciones_underground_mod
-- ------------------------------------------------------
