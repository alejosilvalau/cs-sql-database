...
DROP DATABASE IF EXISTS `afatse_mod`;

CREATE DATABASE `afatse_mod`
    CHARACTER SET 'utf8'
...
INSERT INTO `instructores` (`cuil`, `nombre`, `apellido`, `tel`, `email`, `direccion`, `cuil_supervisor`) VALUES
  ('30-30303030-3','Rosa','Pelaes','3030303','rpelaes77@afatse_mod.com.ar','9 de Julio 3030','99-99999999-9'),
  ('31-31313131-3','Jacinto','Ibañes','3131313','jibañes@afatse_mod.com.ar','Pte. Roca 3131','99-99999999-9'),
  ('55-55555555-5','Henri','Amiel','5555555','hamiel@afatse_mod.com.ar','Ayacucho 5555',NULL),
  ('66-66666666-6','Franz','Kafka','6666666','fkafka@afatse_mod.com.ar','San Luis 666 6F','55-55555555-5'),
  ('77-77777777-7','Francisco','Umbral','7777777','fumbral@afatse_mod.com.ar','Italia 777','55-55555555-5'),
  ('88-88888888-8','Otto','Wagner','8888888','owagner@afatse_mod.com.ar','Rondeau 888','77-77777777-7'),
  ('99-99999999-9','Elias','Yanes','9999999','eyanes@afatse_mod.com.ar','27 de Febrero 999','88-88888888-8');
...
INSERT INTO `materiales` (`cod_material`, `desc_material`, `url_descarga`, `autores`, `tamanio`, `fecha_creacion`, `cant_disponible`, `punto_pedido`, `cantidad_a_pedir`) VALUES
  ('AP-001','Introducción al Marketing','www.afatse_mod.com.ar/apuntes?AP=001','Antonio Gramsci',2.5,'2012-08-01',0,NULL,NULL),
  ('AP-002','Estructura de la PC','www.afatse_mod.com.ar/apuntes?AP=002','Juan Carlos Onetit',3,'2012-08-05',0,NULL,NULL),
  ('AP-003','Sectores de Mercado y Trageting','www.afatse_mod.com.ar/apuntes?AP=003','Rafael Alberti',3.9,'2013-05-08',0,NULL,NULL),
  ('AP-004','Sistemas Operativos Modernos','www.afatse_mod.com.ar/apuntes?AP=004','Andrew Tanembaum',4,'2013-11-27',0,NULL,NULL),
  ('AP-005','Redes','www.afatse_mod.com.ar/apuntes?AP=005','Andrew Tanembaum',7.3,'2013-12-02',0,NULL,NULL),
  ('AP-006','Imagen y Competencia','www.afatse_mod.com.ar/apuntes?AP=006','Rafael Muñiz Gonzales y Erica de Forifregoro',3,'2014-05-04',0,NULL,NULL),
  ('AP-007','Usuarios y Seguridad','www.afatse_mod.com.ar/apuntes?AP=007','Andrew Tanembaum',6,'2014-02-08',0,NULL,NULL),
  ('AP-008','Utilidades de diagnostico','www.afatse_mod.com.ar/apuntes?AP=008','Erica de Forifregoro',4,'2014-04-09',0,NULL,NULL),
  ('AP-009','Deteccion de hackers','www.afatse_mod.com.ar/apuntes?AP=009','Erica de Forifregoro',5.7,'2014-05-17',0,NULL,NULL),
